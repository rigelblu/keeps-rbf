// The store is the source of truth #stay-3 reads back, so a save→load round-trip must be lossless,
...
@Suite struct StoreTests {
    ...
    @Test func roundTripIsLossless() throws {
        let dir = FileManager.default.temporaryDirectory.appendingPathComponent("stay-test-\(UUID().uuidString)")
