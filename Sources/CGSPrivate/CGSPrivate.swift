...
// fragility lives (port of the proven #stay-1/#stay-6 SpikeShared wrappers; dlopen-before-dlsym).
...
private let log = Logger(subsystem: "com.rigelblu.stay", category: "CGSPrivate")
...
// MARK: - Spaces (read-only; proven SIP-on in #stay-1)
