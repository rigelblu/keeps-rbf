...
*Findings from building [keeps-rbf](../README.md). Version-pinned: macOS 26 (arm64), SIP **on**,
"Displays have separate Spaces" on. The load-bearing change landed in macOS Sonoma 14.5 (May 2024).*

## The itch

[Stay](https://cordlessdog.com/keeps/) used to put my windows back when I docked and undocked. It's been
...
[keeps-rbf](../README.md) is built on exactly that footing: capture every window across every desktop (via
