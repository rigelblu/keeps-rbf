...
# 🔵⋯ v0.9.0 (2026-07-07)
*A running carry is legible end to end: the menu-bar item animates with live progress while keeps works, and a notification delivers the honest verdict the moment it's done — you never open the menu to find out what happened.*
...
# 🔵⋯ v0.8.0 (2026-07-07)
*keeps is a real app now: packaged and signed, so the carry offer reaches you as a clickable notification — not just a menu-bar badge you have to remember to check — and permissions stick across updates.*
...
# 🔵⋯ v0.7.0 (2026-07-07)
*One clear restore action: a single menu verb restores everything — silent placements first, then the visible carry for whatever remains — because your explicit click is the consent. The auto path still only offers.*
...
# 🔵⋯ v0.6.0 (2026-07-07)
*Whole-layout restore — the first real MVP: the windows on your current Space still come back silently; the ones stranded on other Spaces are offered back with one tap, with an honest count.*
...
# 🔵⋯ v0.5.0 (2026-07-06)
*Space correctness: your windows return to the right Space too — including across displays — and when keeps can't do that silently it never fakes it; it defers honestly and offers the carry.*
...
# 🔵⋯ v0.4.0 (2026-07-06)
*A diagnostic trace for the dogfooding user: see exactly what restore wanted, where each window was, and where it ended up.*
...
# 🔵⋯ v0.3.0 (2026-06-16)
*The first cross-Space mechanism, manual and one window at a time: a visible carry reliable enough to trust, driven through your own macOS shortcuts.*
